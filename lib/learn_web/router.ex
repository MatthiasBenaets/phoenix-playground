defmodule LearnWeb.Router do
  ...
  scope "/", LearnWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{LearnWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", LearnWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{LearnWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", LearnWeb do
    ...
    live_session :current_user,
      on_mount: [{LearnWeb.UserAuth, :mount_current_user}] do
